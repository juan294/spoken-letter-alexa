...
export const ALEXA_PERSONA = [
  ...
  "carries its url. Copy that same story's `artUrl` into `play.artUrl` unchanged, or null when it has",
  "none; never build one yourself. When asked what is new or available, call list_family_stories and answer without",
